function [SAT_Days,SMT_Days] = UTC2SolarApparentTime_drc(julian_UTC,datenum_UTC,Lon)

% Programmed by Darin C. Koblick (09/04/2011)

% Edited by Dan Chavas (2016-04-29) to allow for days_since as input for
% time
