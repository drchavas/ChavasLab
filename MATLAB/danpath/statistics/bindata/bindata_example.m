%bindata_example.m -- example for plotting a 2D binned dataset
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
offset = 3;
x1 = 2*randn(5000,1) + offset;
x2 = 3*randn(5000,1) + offset;
%x1 = [0 1 2 3] + 0.05;
%x2 = [0 0 0 0] + 0.05;
zz = x1 + x2;
...
%% Save plot
plot_filename = sprintf('bindata_example_hist.png');
...
input_ylabel = 'ydat [-]';
ylabel(input_ylabel)
input_title = sprintf('z=x+y; bin statistic (color): %s; x bins: [%3.2f,%3.2f), y bins: [%3.2f,%3.2f)',statistic,x1rg(1),x1rg(end),x2rg(1),x2rg(end));
title(input_title)
legend(hpl,input_legend)

%% Save plot %%%%%%%%%%%%%%%%%%
plot_filename = sprintf('bindata_example.png');
saveas(gcf,plot_filename,'png')
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%