          function [PMIN,VMAX,AIRSEA,TO,IFL]= pcmin(SST,PSL,P,T,R)
%
...
%
	VREDUC=1; %default = 0.8; BE02 uses 0.9; TE12 uses 0.75
%
%--------------------------------------------------------------------------
%
	SSTK=SST+273.15;
...
%
      while (abs(PNEW-PMOLD)) > 0.2 %DRC 2015-08-24 this threshold doesnt affect result
%
