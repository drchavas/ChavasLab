function varargout = vdist_sphere(lat1,lon1,lat2,lon2)
% VDIST_SPHERE (DRC 03 June 2014) - Same as VDIST but with b=a in
% ellipsoid, with a set to value used in CESM model.
%
%
...
a = 6.37122*10^6;   %CESM value used for Earth's radius
b = a;
