...
%
% Modifications DRC:
%   2017-10-20: added variable counts as output

function [h,counts] = hexscatter_drc( xdata, ydata, varargin )
    ...
    %% DRC 2016-10-20
    %sprintf('Plotting counts normalized by 99.5ile value')
    %counts = counts/prctile(counts,99.5);
    %% DRC 2016-10-20

    %% DRC 2016-12-06
    sprintf('Plotting counts normalized by max value')
