...
!-----------------------------------
      ...
      logical terrain_flag,procfiles,dowr,                                    &
              ...
              dosub,doturbdiag,doazimavg,dohturb,dovturb,pdcomp
...
!-----------------------------------------------------------------------
      ...
      integer nx,ny,nz,nodex,nodey,ppnode,timeformat,timestats,               &
              ...
              ud_hadv,ud_vadv,ud_hturb,ud_vturb,ud_pgrad,ud_rdamp,            &
              ud_pbl,ud_cor,ud_cent,ud_subs,                                  &
              vd_hadv,vd_vadv,vd_hturb,vd_vturb,vd_pgrad,vd_rdamp,            &
...
!-----------------------------------------------------------------------
      ...
      real dx,dy,dz,dtl,timax,run_time,                                       &
           tapfrq,rstfrq,statfrq,prclfrq,turbfrq,azimavgfrq,                  &
           ...
           dgs1,dgs2,dgs3,dgt1,dgt2,dgt3,csound,hurr_rad,                     &
...
!  timestats:
      ...
      real clock_rate,time_sound,time_buoyan,time_turb,              &
           ...
           time_tmix,time_cor,time_fall,time_satadj,                 &
           time_sfcphys,time_last,                                   &
...
!-----------------------------------------------------------------------
      ...
      namelist /param0/ nx,ny,nz,nodex,nodey,ppnode,                    &
